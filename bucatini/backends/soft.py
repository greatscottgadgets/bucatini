...
These can be used to facilitate porting to new SerDes; as they can be used in
place of SerDes components. Eventually, they may prove useful in moving components
into ASICs.
"""
